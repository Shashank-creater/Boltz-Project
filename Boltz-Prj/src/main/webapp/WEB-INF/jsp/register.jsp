...
<body>
	<div>
		 ...
		 <div class=" " style="width: 35%;margin: auto;margin-top: 3%;font-size: 24px;">
			<div id="LoginDiv" class="  p-5 mt-5" style="background:white;border: 1px solid black;">
				<p class="h4 mb-4 text-center">Create Account</p>
				...
				<form action="registeruser" method="post">
				 ...
				 <div class="form-group">
					<input type="password" class="form-control" id="confirmPassword" placeholder="Confirm sPassword">
				 </div>
				...
				<!--  <div class="form-group">
				  ...
				  <div class="text-center">
					Already Have Account ? <a href="<c:url value='/loginpage'></c:url>">Login</a>
				  </div>
